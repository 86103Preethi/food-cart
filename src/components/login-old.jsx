...
import background from '../assets/food folder/background.png';
...
const Login = ({ setIsLoggedIn }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-5 border flex max-w-md w-full border-gray-300 bg-white rounded-lg shadow-md relative z-10">
